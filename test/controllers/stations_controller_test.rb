...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { ignore: @station.ignore, last_seen: @station.last_seen, mac_addr: @station.mac_addr, name: @station.name }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { ignore: @station.ignore, last_seen: @station.last_seen, mac_addr: @station.mac_addr, name: @station.name }
    assert_redirected_to station_path(assigns(:station))
  end
